...
module.exports = function(PackerFile){
  ...
  PackerFile.prototype.addDigitalOcean(api_key, client_id, opts){
      var self = this
  ...
  PackerFile.prototype.addDocker(commit, export_path, image, opts){
    var self = this
  ...
  PackerFile.prototype.addGoogleComputeEngine(account_file, client_secrets_file, private_key_file, project_id, source_image, bucket_name, zone, opts){
    var self = this
  ...
  PackerFile.prototype.addNullBuilder(host, ssh_username, ssh_password, ssh_private_key_file, opts){
    var self = this
  ...
  PackerFile.prototype.addOpenStack(username, password, flavor, provider, image_name, source_image, opts){
    var self = this
  ...
  PackerFile.prototype.addParallelsISO(parallels_tools_flavor, ssh_username, iso_url, iso_checksum, iso_checksum_type, opts){
    var self = this
  ...
  PackerFile.prototype.addParallelsPVM(parallels_tools_flavor, ssh_username, source_path, opts){
    var self = this
    if(typeof parallels_tools_flavor != 'object'){
      opts = opts || {}
      opts.parallels_tools_flavor = parallels_tools_flavor
  ...
  PackerFile.prototype.addQEMU(ssh_username, iso_url, iso_checksum, iso_checksum_type, opts){
    var self = this
  ...
  PackerFile.prototype.addVirtualBoxISO(ssh_username, iso_url, iso_checksum, iso_checksum_type, opts){
    var self = this
    if(typeof ssh_username != 'object'){
      opts = opts || {}
      opts.ssh_username = ssh_username
  ...
  PackerFile.prototype.addVirtualBoxOVF(ssh_username, source_path, opts){
    var self = this
    if(typeof ssh_username != 'object'){
      opts = opts || {}
      opts.ssh_username = ssh_username
  ...
  PackerFile.prototype.addVMWareISO(ssh_username, iso_url, iso_checksum, iso_checksum_type, opts){
    var self = this
    if(typeof ssh_username != 'object'){
      opts = opts || {}
      opts.ssh_username = ssh_username
  ...
  PackerFile.prototype.addVMWareVMX(ssh_username, source_path, opts){
    var self = this
    if(typeof ssh_username != 'object'){
      opts = opts || {}
      opts.ssh_username = ssh_username
